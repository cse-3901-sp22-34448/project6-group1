...
class PresentationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presentation" do
    assert_difference('Presentation.count') do
      post presentations_url, params: { presentation: { class_infos_id: @presentation.class_infos_id, name: @presentation.name, user_id: @presentation.user_id } }
    end
  ...
  test "should update presentation" do
    patch presentation_url(@presentation), params: { presentation: { class_infos_id: @presentation.class_infos_id, name: @presentation.name, user_id: @presentation.user_id } }
